...
// Route::apiResource('products',ProductController::class)->middleware('auth:web-api');
    ...
    Route::post('auth/points', [HomeController::class, 'points']);
    Route::post('auth/notifications', [HomeController::class, 'notifications']);
    Route::post('auth/filter_products', [HomeController::class, 'filter_products']);
